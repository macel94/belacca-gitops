...
def main():
    try:
        ...
        for marker in ('35 daily verified backups','12 monthly verified backups','TLS is required','pong-backup-object-store','pong-backup-encryption','pong-backup-restore-object-store','CronJobs use externally managed gates','pong-api-data'):
